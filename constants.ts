...
const SYLLABUS_DATA: Record<string, Record<string, string[]>> = {
  math: {
    ...
    [ClassLevel.S3]: [
      ...
      'Matrices and Transformations', 'Linear Programming (Intro)'
    ],
    [ClassLevel.S4]: [
      ...
      'Integration (Intro)', 'Revision and Past Papers'
    ]
  },
  biology: {
    [ClassLevel.S1]: [
    ...
    [ClassLevel.S2]: [
      ...
      'Nutrition in Animals', 'Transport in Plants and Animals',
    ...
    [ClassLevel.S4]: [
      'Reproduction in Plants and Animals', 'Genetics and Inheritance', 
      'Evolution and Variation', 'Interrelationships (Ecology)', 
      'Population Dynamics', 'Applied Biology'
    ]
  },
  chemistry: {
    [ClassLevel.S1]: [
    ...
    [ClassLevel.S4]: [
      ...
      'Applied Chemistry (Polymers, Soaps)'
    ]
  },
  physics: {
    [ClassLevel.S1]: [
    ...
    [ClassLevel.S2]: [
      ...
      'Structure of Matter', 'Heat Transfer'
    ],
    [ClassLevel.S3]: [
  ...
  geography: {
    ...
    [ClassLevel.S3]: [
      ...
      'Map Reading (Photography)', 'Fieldwork'
    ],
    [ClassLevel.S4]: [
  ...
  ict: {
    ...
    [ClassLevel.S3]: ['Spreadsheets (Excel)', 'Presentations (PowerPoint)', 'Data Communication', 'Ethical Issues in ICT'],
    [ClassLevel.S4]: ['Database Management', 'Web Design (HTML Basic)', 'Desktop Publishing', 'Future Trends in ICT']
  },
  ent: {
    [ClassLevel.S1]: ['Meaning of Entrepreneurship', 'Personal Branding', 'Creativity and Innovation', 'Savings and Investment'],
